         ...
         <nav class="navbar navbar-inverse nav">
              <div class="container-fluid">
                <div class="navbar-header">
                  ...
                  <span class="ch"><a style="color: white;" href="index.html">Joy Creative Tools</a></span>
                </div>
    ...
    <section id="main" style="margin-top:100px;">
     ...
     <div class="container">
      ...
      <label for="bn">NTA</label>
			...
			<input type="text" class="form-control" name="dname" placeholder="penggalang" required>
			</div><br>
			<div class="form-group">
